...
public class Notice {
	...
	//파일업로드를 위해
	/*private CommonsMultipartFile file; //업로드한 파일정보를 담는 변수, 단 조건 input 태그 name값하고 같아야 함
	...
	업로드 파일이 1개일때 쓰는거니까 다중파일 업로드에는 쓸수 없지*/
	...
	public String toString() {
		return "Notice [seq=" + seq + ", title=" + title + ", writer=" + writer + ", regdate=" + regdate + ", fileSrc="
				+ fileSrc + ", fileSrc2=" + fileSrc2 + ", hit=" + hit + ", content=" + content + "]";
	}
